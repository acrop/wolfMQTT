...
typedef void (*MqttSleepMs)(void *app_ctx, word32);
...
WOLFMQTT_LOCAL int mqtt_receive_msg(struct ringbuf *on_message_rb, uint8_t *buffer, uint32_t buffer_len);
