...
{
	size_t power_of_two;
	for (power_of_two = 1; 1ull << power_of_two < expect_capacity; ++power_of_two) {}
...
{
	size_t capacity_power_of_2 = ringbuf_power_of_2(capacity);
	if (capacity != capacity_power_of_2)
	{
		return false;
	}
	rb->data = data;
